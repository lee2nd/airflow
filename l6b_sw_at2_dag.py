...
data_path = "/home/ivan/Program/AT_DATA/l6b_sw_at2"
        ...
        if all([cond_1_1,cond_1_2,cond_1_3]):
            ...
            for i in range(1,len(fileloglines)):
                ...
                if time_difference.total_seconds()/60 <= trigger_setting.time_difference:
                    ...
                    eqp_id = filelog[1]
                    recipe_id = filelog[2]
                    if filelog[6][0] != 'E' or len(filelog[6]) < 3: continue
                    if filelog[6][:2] not in ["EE","EG","EK","EJ","EM","EL"]: continue                    
                    chip_id = filelog[6]
